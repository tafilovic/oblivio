        ...
        Column(
            ...
            Column {
                ...
                OblivioTextField(
                    ...
                    onValueChange = { onIntent(SignInIntent.UsernameChanged(it)) },
                    label = stringResource(id = R.string.sign_in_username_label),
                )
                Spacer(modifier = Modifier.height(12.dp))
                OblivioTextField(
                    ...
                    trailingIcon = {
                        IconButton(onClick = { onIntent(SignInIntent.TogglePasswordVisibility) }) {
                            Icon(
                                ...
                                contentDescription = stringResource(id = R.string.sign_in_toggle_password_content_desc),
                            )
                        }
                    },
                )
                ...
                OblivioPrimaryButton(
                    text = stringResource(id = R.string.sign_in_action),
                    modifier = Modifier.fillMaxWidth(),
                    onClick = { onIntent(SignInIntent.Submit) },
                )
                Spacer(modifier = Modifier.height(12.dp))
                OblivioSecondaryButton(
                    text = stringResource(id = R.string.sign_in_register_action),
                    modifier = Modifier.fillMaxWidth(),
                    onClick = { onIntent(SignInIntent.OpenRegister) },
                )
            }
...
private fun SignInPreviewLight() {
    OblivioTheme {
        SignInScreen(state = SignInState(), onIntent = {})
    }
}
